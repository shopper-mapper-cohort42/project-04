...
function Location({ apiKey, mapState, geocodingLayer, setGeocodingLayer, geocodingLayerDefined, setGeocodingLayerDefined, clearAllLayers }) {
                ...
                <>
                    <section className="locationSection">
                        <div className="wrapper">
                            <div className={togglePopup ? 'locationPopup active' : 'locationPopup'}>
                            ...
                            <div className="locationForm">
                                ...
                                <form onSubmit={(e) => handleSubmit(e, location)}>
                                    <div className={closeDropDown ? 'userLocationDiv' : 'userLocationDiv active'}>
                                        <label htmlFor="name" className="sr-only">
                                            Enter your location
                                        </label>
                                        <input autoComplete="off" type="text" id="name" className="userLocationInput" onChange={searchLocation} value={location} onFocus={() => setCloseDropDown(false)} placeholder="Enter Your Location" required />
                                ...
                                <div className="locationPredictiveResults">
                                    <ul tabIndex="0" className={closeDropDown ? null : 'active'}>
                                        {predictiveResults.map((result, index) => {
                                            return (
                                                <li key={index} onClick={(e) => autoFill(e)} tabIndex="0">
