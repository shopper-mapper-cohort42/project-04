        ...
        <>
            ...
            <main id="mainContent">
                <Routes>
                    ...
                    <Route path="/location" element={<Location apiKey={apiKey} mapState={mapState} geocodingLayer={geocodingLayer} setGeocodingLayer={setGeocodingLayer} geocodingLayerDefined={geocodingLayerDefined} setGeocodingLayerDefined={setGeocodingLayerDefined} />} />
